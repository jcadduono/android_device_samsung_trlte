...
TARGET_PREBUILT_KERNEL := device/samsung/trlte/zImage
TARGET_PREBUILT_DTB := device/samsung/trlte/dtb.img
...
BOARD_CUSTOM_BOOTIMG_MK :=  device/samsung/trlte/bootimg.mk
...
TARGET_LIBINIT_DEFINES_FILE := device/samsung/trlte/init/init_trlte.cpp
